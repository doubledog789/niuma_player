/// example app 的 UI 资源路径常量。
///
/// 资源来自 niuma-player-assets v1.1（31 控件 + 5 进度条表情 + loading 动画），
/// 以 SVG 形式打包在 **example app 自己**的 `assets/` 下（headless 核不再固定
/// 这些 UI 资源）。路径是 app 相对的，不带 `packages/niuma_player/` 前缀。
///
/// 用法：
/// ```dart
/// SvgPicture.asset(
///   NiumaUiAssets.icPlay,
///   width: 24,
...
class NiumaUiAssets {
  ...
  static const String _ctrl = 'assets/player_controls';
  static const String _thumb = 'assets/progress_thumbs';
  static const String _load = 'assets/loading';
  ...
  static const String icFullscreenLandscape =
      '$_ctrl/ic_fullscreen_landscape.svg';
...
/// 进度条 thumb 的 5 种表情状态。
///
/// 由 [NiumaUiAssets.thumbForState] 映射到具体 SVG 资源。
